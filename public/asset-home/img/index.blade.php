...
<head>
  ...
  <link href="/asset-home/img/logo.png" rel="apple-touch-icon">
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        ...
        <a href="/"><img src="/asset-home/img/logo.png" alt="" class="img-fluid"><span style="color: white;"> Rifan Financindo Berjangka <strong>Surabaya</strong></span></a>
      </div>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#features">Produk</a></li>
          <li><a class="nav-link scrollto" href="#gallery">Edukasi</a></li>
          <li><a class="nav-link scrollto" href="#team">Karir</a></li>
          <li><a class="nav-link scrollto" href="#pricing">Blog</a></li>
      ...
      <div class="row justify-content-between">
        <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
          <div data-aos="zoom-out">
            <h1>Rifan Financindo Berjangka <span>Surabaya</span></h1>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5" data-aos="fade-left">
            <h3>Tentang PT. Rifan Financindo Berjangka Surabaya</h3>
            <p>PT. Rifan Financindo Berjangka Surabaya hadir sebagai perusahaan yang berorientasi kepada layanan jasa yang memberikan fasilitas dan edukasi terbaik bagi masyarakat yang tertarik untuk mendapatkan keuntungan dalam perdagangan komoditas dan pasar derivatif di Indonesia. Perusahaan telah didukung oleh teknologi informasi yang mumpuni dan sumber daya manusia profesional yang memenuhi standar kualifikasi kepatutan dan kompetensi oleh pemerintah yang dinaungi oleh <strong>Badan Pengawas Perdagangan Berjangka Komoditi (BAPPEBTI)</strong></p>
      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-md-4" data-aos="fade-right">
            <img src="/asset-home/img/details-1.png" class="img-fluid" alt="">
          </div>
          <div class="col-md-8 pt-4" data-aos="fade-up">
            <h3>OLEIN</h3>
            <p class="fst-italic">
              Produk pertama berupa olein atau minyak. Olein yang menjadi produk kami merupakan olein yang sudah memenuhi standar pasar.</p>
              <p>Produk ini terbilang aset jangka panjang yang sangat menguntungkan, karena notabennya produk olein adalah  sumber daya yang bisa diperbarui dan selalu dibutuhkan masyarakat diseluruh dunia untuk kegiatan sehari hari, contohnya seperti memasak, bahan baku industri oleochemical, makanan, dan berbagai non-food application lainnya.</p>
            
            <ul>
              <li><i class="bi bi-check"></i>Dasar Kontrak : 	Olein dengan kualitas Standar Pasa</li>
              <li><i class="bi bi-check"></i>Satuan Kontrak : 20 ton (20.000 Kg)</li>
              <li><i class="bi bi-check"></i>Bulan Kontrak : 6 (enam) bulan berturut-turut, sehingga setiap hari perdagangan terdapat enam Bulan Kontrak</li>
              <li><i class="bi bi-check"></i>Hari & Jam Perdagangan : Setiap hari perdagangan
                Pukul 09.30 – 17.30 wib</li>
            </ul>
            <p>
        ...
        <div class="row content">
          <div class="col-md-4 order-1 order-md-2" data-aos="fade-left">
            <img src="/asset-home/img/details-2.png" class="img-fluid" alt="">
          </div>
          <div class="col-md-8 pt-5 order-2 order-md-1" data-aos="fade-up">
            <h3>GOLD 1Kg</h3>
            <p class="fst-italic">
              Produk kedua merupakan emas 1kg dengan mutu kualitas kemurnian minimum 99,99% dilengkapi dengan angka seri & stempel dari refineri yang diakui oleh LBMA (bisa dari dalam dan luar negeri). 
            </p>
            <p>
              Aset emas merupakan pilihan terbaik untuk aset jangka panjang yang sangat menguntungkan dikarenakan kualitas dan daya simpannya yang tahan untuk waktu yang lama dan berkelanjutan
            </p>
            <ul>
              <li><i class="bi bi-check"></i>Dasar Kontrak : 	1 kg Emas dengan 99.9 finest kualitas LBMA</li>
              <li><i class="bi bi-check"></i>Satuan Kontrak : 1 kg (1000 gram)</li>
              <li><i class="bi bi-check"></i>Bulan Kontrak : 3 (tiga) bulan berturut-turut, sehingga setiap hari perdagangan terdapat 3 (tiga) Bulan Kontrak</li>
              <li><i class="bi bi-check"></i>Hari & Jam Perdagangan : Setiap hari perdagangan</li>
            </ul>
            <p>
        ...
        <div class="row content">
          <div class="col-md-4" data-aos="fade-right">
            <img src="/asset-home/img/details-3.png" class="img-fluid" alt="">
          </div>
          <div class="col-md-8 pt-5" data-aos="fade-up">
            ...
            <ul>
              <li><i class="bi bi-check"></i>Dasar Kontrak : 	250 gram Emas dengan 99.9 finest kualitas LBMA</li>
              <li><i class="bi bi-check"></i>Satuan Kontrak : 250 gram</li>
              <li><i class="bi bi-check"></i>Bulan Kontrak : 3 (tiga) bulan berturut-turut, sehingga setiap hari perdagangan terdapat 3 (tiga) Bulan Kontrak</li>
              <li><i class="bi bi-check"></i>Hari & Jam Perdagangan : Setiap hari perdagangan</li>
            </ul>
            <p>
        ...
        {{-- <div class="row content">
          <div class="col-md-4 order-1 order-md-2" data-aos="fade-left">
            <img src="/asset-home/img/details-4.png" class="img-fluid" alt="">
          </div>
          <div class="col-md-8 pt-5 order-2 order-md-1" data-aos="fade-up">
        ...
        <div class="row" data-aos="fade-left">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member" data-aos="zoom-in" data-aos-delay="100">
              <div class="pic"><img src="/asset-home/img/team/team-1.jpg" class="img-fluid" alt=""></div>
          ...
          <div class="col-lg-3 col-md-6 mt-5 mt-md-0">
            <div class="member" data-aos="zoom-in" data-aos-delay="200">
              <div class="pic"><img src="/asset-home/img/team/team-2.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Sarah Jhonson</h4>
          ...
          {{-- <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
            <div class="member" data-aos="zoom-in" data-aos-delay="300">
              <div class="pic"><img src="/asset-home/img/team/team-3.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Rifan Financindo Berjangka Surabaya</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
