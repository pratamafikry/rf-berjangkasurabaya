...
<header id="header" class="fixed-top d-flex align-items-center header-transparent">
  ...
  <div class="container d-flex align-items-center justify-content-between">
    ...
    <nav id="navbar" class="navbar">
      <ul>
        <li><a class="nav-link scrollto active" href="/">{{__('beranda')}}</a></li>
        <li class="dropdown"><a href="#about"><span>{{__('about')}}</span> <i class="bi bi-chevron-down"></i></a>
          <ul>
            <li><a href="/legalitas-perusahaan">{{__('legalitas')}}</a></li>
            <li><a href="/fasilitas-layanan">{{__('fasilitas')}}</a></li>
          </ul>
        <li class="dropdown"><a href="#details"><span>{{__('produk')}}</span> <i class="bi bi-chevron-down"></i></a>
          <ul>
            <li><a href="/ilustrasi">{{__('ilustrasi')}}</a></li>
            <li><a href="/kelebihan">{{__('kelebihan')}}</a></li>
        ...
        <li class="dropdown"><a href="#features"><span>{{__('prosedur')}}</span> <i class="bi bi-chevron-down"></i></a>
          <ul>
        ...
        <li><a class="nav-link scrollto" href="/#contact">{{__('kontak')}}</a></li>
