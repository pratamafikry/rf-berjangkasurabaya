    ...
    <div class="col-md-4">
        <main class="form-registration w-100 m-auto">
            <form action="/register" method="post">
              ...
              <h1 class="h3 mb-3 fw-normal">Marketing Registration</h1>
              ...
              <select class="form-select mb-2" aria-label="Default select example" name = "team_id" style="height:55px;" required value="{{old('team_id')}}">
